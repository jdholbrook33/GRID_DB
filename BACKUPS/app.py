...
from keypad_page import display_keypad
...
def main():
    ...
    # Add a button to go to the keypad page
    if selected_page != "Keypad" and st.sidebar.button("Go to Keypad"):
        st.session_state.page = 'Keypad'
        st.rerun()
